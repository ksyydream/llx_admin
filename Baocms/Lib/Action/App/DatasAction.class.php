...
class  DatasAction extends  CommonAction{
    ...
    public function cityareas(){
        ...
        $data['province']       = D('Province')->fetchAll();
	...
	public  function cityarea(){
        $data = array();
        $data['city']       = D('Ncity')->select();
        $data['area']       = D('Narea')->select();
        $data['province']       = D('Nprovince')->select();
        header("Content-Type:application/javascript");
        echo   'var  cityareas = '.  json_encode($data);die;
    }
    /*public  function cityarea(){
        $data = array();
        $data['city']       = D('Ncity')->fetchAll();
        $data['area']       = D('Narea')->fetchAll();
        $data['province']       = D('Nprovince')->fetchAll();
        header("Content-Type:application/javascript");
        echo   'var  cityareas = '.  json_encode($data);die;
    }*/
